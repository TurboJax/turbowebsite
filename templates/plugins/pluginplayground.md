...
## This plugin is created by me so that new developers can see examples of how to do different things when making plugins.  This includes but is not limited to, bukkit commands, the brigadier command api, yaml file configurations, file management, SQL drivers, event listeners, and more.
